    ...
    <div class="grid12 wi90 ma val nogrg">
        ...
        <?php if(have_rows('valeur_1')): ?>
            <?php while(have_rows('valeur_1')): the_row() ?>
                <div class="valeur v1" style="background-image: url('<?= get_sub_field('image') ?>')">
                </div>
        ...
        <?php if(have_rows('valeur_2')): ?>
            <?php while(have_rows('valeur_2')): the_row() ?>
                <div class="valeur v2 rellax" data-rellax-speed="-0.5" style="background-image: url('<?= get_sub_field('image') ?>')">
                </div>
        ...
        <?php if(have_rows('valeur_3')): ?>
            <?php while(have_rows('valeur_3')): the_row() ?>
                <div class="valeur v3 rellax" data-rellax-speed="-1" style="background-image: url('<?= get_sub_field('image')['url'] ?>')">
