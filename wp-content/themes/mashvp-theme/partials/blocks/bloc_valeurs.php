    ...
    <div class="grid12 wi90 ma val nogrg">
        ...
        <?php if(have_rows('valeur_1')): ?>
            <?php while(have_rows('valeur_1')): the_row() ?>
                <div class="valeur v1 rellax" data-rellax-speed="-3" style="background-image: url('<?= get_sub_field('image') ?>')">
                </div>
                <div class="valeurtextcontainer e1">
                    <div class="valeurtextcontent">
                        ...
                        <?php if(get_sub_field('btn_link') && get_sub_field('btn_text')): ?>
                            <a class="valeurbtn" href="/mikamino/la-marque-coton-bio-gots-mikamino/#<?= get_sub_field('btn_link') ?>"><?= get_sub_field('btn_text') ?></a>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endwhile; ?>
        ...
        <?php if(have_rows('valeur_2')): ?>
            <?php while(have_rows('valeur_2')): the_row() ?>
                <div class="valeur v2" style="background-image: url('<?= get_sub_field('image') ?>')">
                </div>
        ...
        <?php if(have_rows('valeur_3')): ?>
            <?php while(have_rows('valeur_3')): the_row() ?>
                <div class="valeur v3 rellax" data-rellax-speed="3" style="background-image: url('<?= get_sub_field('image')['url'] ?>')">
